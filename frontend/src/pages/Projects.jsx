    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-1">Organize your traces into projects</p>
        </div>
        <button
      ...
      {projects.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-12 text-center">
          ...
          <p className="text-slate-400 text-sm mt-1">Create your first project to organize your traces.</p>
          <button
            onClick={() => setShowModal(true)}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map(project => (
            <div key={project.id} className="bg-white rounded-2xl shadow-sm border border-slate-200/60 overflow-hidden hover:shadow-md transition-all group">
              <div className="p-6">
                ...
                <h3 className="text-lg font-semibold text-slate-800 mt-4">{project.name}</h3>
